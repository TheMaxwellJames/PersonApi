    ...
    <section class="content">
      ...
      @include('message')
        ...
        <div class="card-header">
              <h3 class="class-title">Blog Page</h3>
        </div>

        <form action="{{ url('admin/blog/add') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" name="title" class="form-control" placeholder="Blog Title" value="" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
               <textarea name="description" type="text" class="form-control" placeholder="Blog Description"></textarea>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
               <textarea name="description_text_editor" type="text" class="form-control editor" placeholder="Text Editor"></textarea>
